<!--<template>-->
<!--  &lt;!&ndash;  <div class="container-fluid mt-3">&ndash;&gt;-->
<!--  <div class="row">-->
...
<!--<script>-->
<!--import SideBar from '@/components/ResultsOfSearchPage/Sidebar.vue';-->
<!--import ListOfCourses from '@/components/ResultsOfSearchPage/ListOfCourses.vue';-->
...
<!--    async fetchCourses() {-->
<!--      try {-->
<!--        const response = await axios.get('/testJSON/courseData.json'); // Путь к вашему JSON файлу-->
<!--        this.courses = response.data.courses;-->
<!--        this.filteredCourses = this.courses; // По умолчанию показываем все курсы-->
...
<!--      // Логика для фильтрации курсов на основе выбранных фильтров-->
<!--      this.filteredCourses = this.courses.filter(course => {-->
<!--        // Пример фильтрации по типу курса-->
<!--        return (-->
<!--            (!filters.types.length || filters.types.includes(course.type)) &&-->
<!--            (!filters.levels.length || filters.levels.includes(course.level)) &&-->
<!--            (!filters.languages.length || filters.languages.includes(course.language))-->
<!--        );-->
<!--      });-->
<!--    }-->
<!--  },-->
<!--  mounted() {-->
<!--    this.fetchCourses(); // Загружаем курсы при монтировании компонента-->
<!--  }-->
<!--};-->
<!--</script>-->
...
export default {
  ...
  methods: {
    ...
    handleFilters(filters) {
      ...
      this.filteredCourses = this.courses.filter(course => {
        return (
            (!filters.keywords || course.title.includes(filters.keywords)) &&
            (!filters.direction || course.direction === filters.direction) &&
